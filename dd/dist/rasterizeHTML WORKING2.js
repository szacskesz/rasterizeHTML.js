      ...
      module.calculateDocumentContentSize = function (element, options) {
          return new Promise(function (resolve, reject) {
              ...
              iframe.onload = function () {
                  try {
                      var doc = iframe.contentDocument;
                      var size = calculateContentSize(findCorrelatingElement(element, doc), options.clip, options.width, options.height, zoom);
  ...
  var rasterizeHTML = (function (util, browser, rasterize) {
       ...
       */
        module.drawElement = function () {
            ...
            var params = {
                canvas: null,
                options: { selectorFn: arguments[1] }
            };
